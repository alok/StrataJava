#!/usr/bin/env bash
# Insecure landrun shim copied from leanprover/comparator@master scripts/.
# Does NOT sandbox. Use only on platforms without real landrun (macOS, …).
# On Linux, install upstream landrun and let scripts/check-comparator.sh prefer it.
